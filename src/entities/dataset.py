class Dataset:
    ...
    def __init__(self, description_file_exists = False, data_exists = False, licence_file_exists = False, path = "", name = "", descr_short = "", descr_long = "", licence ="", zipname = "", show_on_website = False, folder_name = ""):
