...
class UI:
    ...
    def start(self):
        ...
        for folder in folder_list:
            ...
            if not json_exists or os.stat(json_path).st_size == 0:
                ...
                if long_desc == "":
                    self._io.write("\033[1;33;40mYou chose that the folder doesn't have a long description.\033[0;37;40m")
                else:
    ...
    def ask_sh_desc(self):
        sh_desc = ""
        while sh_desc == "":
            self._io.write("\033[1;31;40mThe folder doesn't have a short description.\033[0;37;40m")
            sh_desc = self._io.read("Please give a short description: ")
        return sh_desc

    def ask_long_desc(self):
        self._io.write("\033[1;31;40mThe folder doesn't have a long description.\033[0;37;40m")
