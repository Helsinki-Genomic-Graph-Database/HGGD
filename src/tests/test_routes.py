...
class TestRoutes(unittest.TestCase):
    ...
    def test_index(self):
        with self.app as test_client:
            ...
            assert b'<hy-heading heading="h5">Datasets in database</hy-heading>' in res.data
    ...
    def test_datasetpage(self):
        with self.app as test_client:
            ...
            assert b'<hy-heading heading="h2"> Testdata for e coli 1 </hy-heading>' in res.data
    ...
    def test_dataset_source_page(self):
        with self.app as test_client:
            ...
            assert b'<hy-heading heading="h2"> Source links for Testdata for e coli 1</hy-heading>' in res.data
